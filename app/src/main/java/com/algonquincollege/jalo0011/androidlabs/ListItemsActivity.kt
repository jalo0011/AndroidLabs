...
class ListItemsActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imageBtn = findViewById<ImageButton>(R.id.imageBtn)
        ...
        var switch = findViewById<Switch>(R.id.listSwitch)
        ...
        var checkBox = findViewById<CheckBox>(R.id.listCheckbox)

        checkBox.setOnCheckedChangeListener({ e, f ->
            var builder = AlertDialog.Builder(this)
            builder.setMessage("dialog message!!!!!!!!!")
                    .setTitle("Checkbox")
                    .setPositiveButton("Ok", {dialong, id ->
